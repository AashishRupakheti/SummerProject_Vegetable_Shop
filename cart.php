		...
		<ul class="nav-justified" style="background-color:green;">
			...
			<li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" style="color:white">Category <span class="caret"></span></a>
				<ul class="dropdown-menu" >
					<li><a href="product.php?category=Vegetables">Fruits</a></li>
					<li><a href="product.php?category=Fruits">Vegetables</a></li>
	...
	<div class="container">
		...
		<h2 class='text-center'>Cart</h2>
			...
			<?php
				...
				$query4="SELECT cart.*,product.product_name,product.product_brand,product.product_image FROM cart,product WHERE cart_user_id='$id' and cart.cart_product_id=product.product_id";
				...
				while($row=mysqli_fetch_assoc($result4)){
					...
					echo "<h4>Quantity: ".$row['cart_quentity']."</h4>";
					echo "<h4>Total: Rs. ".$row['cart_total_price']." .00</h4>";
