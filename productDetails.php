...
<body >
	...
	<div class="container-fluid container">
		...
		<?php
			$query3="SELECT product_name,product_brand,product_category,product_price,product_size,product_description,product_image FROM product WHERE product_id='$p_id'";
			$result3=mysqli_query($sql_connection,$query3);
			while($row=mysqli_fetch_assoc($result3)){
		...
		<div class="row">
			...
			<div class="col-md-5"  style="float:right">
				<div  style="border-radius: 25px" class="thumbnail ">
					...
					<form method="post">
							Quantity
							<input type="number" name="quentity" min="1" max="10" step="1" value="1">
							<br>
