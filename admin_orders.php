	...
	<div class="container">
		...
		<?php
			...
			if($status=='new'){
				...
				echo "<tr>";
				echo "<th>User ID</th><th>Product Name</th><th>Quantity</th><th>Total Price</th><th>Order Placed Date/Time</th><th>Status</th>";
				echo "</tr>";
				...
				while($row=mysqli_fetch_assoc($result4)){
					...
					echo "</td>";
					echo "<td>";
					echo "Rs. ".$row['order_total_price']." .00";
					echo "</td>";
					echo "<td>";
					echo $row['order_date'];
					echo "</td>";
			...
			if($status=='history'){
				...
				echo "<table style='table-layout:fixed;width:100%'>";
				echo "<tr>";
				echo "<th>UserID</th<th>Product Name</th><th>Quantity</th><th>Total Price</th><th>Order Placed Date/Time</th><th>Status</th>";
				echo "</tr>";
