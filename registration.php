...
<body >
	...
	<div class="jumbotron text-center" style="background-image: url('images/slide2.jpg');background-size: cover;margin-bottom: 0px;">
		<h1><font color="white">Rupakheti General sSuppliers</font></h1>
...
<?php
	...
	if(isset($_POST["register"])){
		...
		if(mysqli_num_rows($user_name_validation)>0){
			...
			$query="INSERT INTO user (user_first_name,user_last_name,user_name,user_password,user_address_no,user_address_street,user_address_town,user_tp,user_email) VALUES('$fname','$lname','$username','$password','$no','$street','$town','$tp','$email')";
